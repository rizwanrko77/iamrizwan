    ...
    <PageLayout>
      <article className="bio-article">
        ...
        <FadeIn>
          <section className="bio-section">
            <h2>The Networker</h2>
            <p>I started The Networker in early 2018, before COVID, as a sole proprietor. It was a recruitment business, and it was just me: working from my room, on my phone, reaching out to companies, and placing candidates. It survived COVID, and after that, it actually took off. At my best I was making around 2.5 lakhs a month, alone, no team, no office. Clients stayed because I delivered faster and more directly than the vendors they were used to.</p>
        ...
        <FadeIn>
          <section className="bio-section">
            ...
            <p>At our peak we had 32 people, half interns and half full-time, mostly in recruitment and management. I gave people full freedom and no goals, expecting them to treat it like their own company. Most of them were confused about their role. I was not managing the team or business as a good leader should, I didn&apos;t train people, plan the finances, or execute well enough. I hired too fast and too many, and kept ignoring the warning signs which I shouldn&apos;t have.</p>
        ...
        <FadeIn>
          <section className="bio-section">
            <h2>Tharom</h2>
            <p>As of now I&apos;m building <a href="https://tharom.com" target="_blank" rel="noopener noreferrer">Tharom</a>, an AI infrastructure for organizations with knowledge bases of their own. The idea is to build an AI-native ecosystem that keeps expert humans in the loop to enable &ldquo;knowledge owners&rdquo; to empower their users to learn from their knowledge with the capabilities of AI in a controlled and monitored way.</p>
        ...
        <FadeIn>
          <section className="bio-section">
            ...
            <p style={{
              ...
              &ldquo;I know what a small mistake looks like before it becomes the one that ends the company; I&apos;ve lived on both sides of that line and learned lessons the hard way.&rdquo;
            </p>
          </section>
        </FadeIn>
        ...
        <FadeIn>
          <p className="quiet-invite">
            Thank you for reading my journey. If any of this resonates, <Link href="/contact">let&apos;s talk →</Link>
          </p>
        </FadeIn>
      </article>
    </PageLayout>
